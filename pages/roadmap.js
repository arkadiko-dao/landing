...
export default function PressReview() {
  return (
    <div className="flex flex-col min-h-screen font-sans">
      <div className="fixed w-screen h-screen overflow-hidden bg-zinc-900" style={{zIndex: "-1"}}>
        <Image
          alt=""
          src="/arkadiko-gradient-1.png"
          layout="fill"
          objectFit="cover"
          quality={100}
        />
      ...
      <Head>
        ...
        <title>Arkadiko Finance — Roadmap</title>
            ...
            <div class="space-y-16">
              {ITEMS.map((item) => (
                <article class="relative group">
                  ...
                  <div class="relative">
                    <h3 class="text-base font-bold tracking-tight text-white pt-8 lg:pt-0">{item.title}</h3>
