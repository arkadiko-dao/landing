        ...
        <div className="lg:w-1/2 xl:pr-16">
          ...
          <div className="mt-10 sm:flex sm:justify-center lg:justify-start">
            ...
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3">
              <a href="#" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base text-white rounded-md bg-transparent hover:bg-transparent md:py-4 md:text-lg md:px-10 focus:focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Docs
              </a>
            </div>
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3">
