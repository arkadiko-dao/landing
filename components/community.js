export default function Community() {
  return (
    <div className="bg-gray-100 bg-opacity-80 relative py-16 sm:py-48">
        ...
        <div className="relative">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-indigo-50 border-2 border-indigo-300 shadow-lg sm:grid sm:grid-cols-3">
                <a href="" className="flex flex-col hover:bg-indigo-100 rounded-l-lg border-b border-indigo-300 p-6 text-center sm:border-0 sm:border-r">
                ...
                <a href="" className="flex flex-col hover:bg-indigo-100 border-t border-b border-indigo-300 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                ...
                <a href="" className="flex flex-col hover:bg-indigo-100 rounded-r-lg border-t border-indigo-300 p-6 text-center sm:border-0 sm:border-l">
