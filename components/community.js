          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <dl className="rounded-lg bg-white border-2 border-indigo-300 shadow-lg sm:grid sm:grid-cols-3">
                <a href="https://twitter.com/ArkadikoFinance/" className="flex flex-col hover:bg-indigo-50 rounded-l-lg border-b border-indigo-300 p-6 text-center sm:border-0 sm:border-r">
                ...
                <a href="" className="flex flex-col hover:bg-indigo-50 rounded-r-lg border-t border-indigo-300 p-6 text-center sm:border-0 sm:border-l">
