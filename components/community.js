          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                ...
                <a target="_blank" rel="noopener noreferrer" className="cursor-not-allowed flex flex-col hover:bg-indigo-50 rounded-b-lg sm:rounded-r-lg sm:rounded-l-none border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
