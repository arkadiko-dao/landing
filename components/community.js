          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="rounded-lg bg-white shadow-lg sm:grid sm:grid-cols-3">
                <a href="https://discord.gg/7UB6JjjCNV" target="_blank" rel="noopener noreferrer" className="flex flex-col hover:bg-indigo-50 rounded-t-lg sm:rounded-r-none sm:rounded-l-lg border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  ...
                  <div className="order-1 text-5xl font-extrabold text-indigo-600">
                    ...
                    <p className="mt-3 text-sm sm:mt-4 text-gray-800">
                      Chat with other community members and with the team.
                    </p>
                  </div>
                </a>
                <a href="https://twitter.com/ArkadikoFinance/" target="_blank" rel="noopener noreferrer" className="flex flex-col hover:bg-indigo-50 border-t border-b border-gray-100 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="cursor-not-allowed flex flex-col hover:bg-indigo-50 rounded-b-lg sm:rounded-r-lg sm:rounded-l-none border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                  <p className="order-2 mt-4 text-sm leading-6 text-indigo-500">Discourse</p>
                  <div className="order-1 text-5xl font-extrabold text-indigo-600">
