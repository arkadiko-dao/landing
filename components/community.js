        ...
        <div className="relative">
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <div className="rounded-lg bg-white border-2 border-indigo-300 shadow-lg sm:grid sm:grid-cols-3">
                <a href="https://discord.gg/7UB6JjjCNV" target="_blank" rel="noopener noreferrer" className="flex flex-col hover:bg-indigo-50 rounded-t-lg sm:rounded-r-none sm:rounded-l-lg border-b border-indigo-300 p-6 text-center sm:border-0 sm:border-r">
                  <p className="order-2 mt-4 text-sm leading-6" style={{color: '#5865F2'}}>Discord</p>
                ...
                <a href="https://twitter.com/ArkadikoFinance/" target="_blank" rel="noopener noreferrer" className="flex flex-col hover:bg-indigo-50 border-t border-b border-indigo-300 p-6 text-center sm:border-0 sm:border-l sm:border-r">
                  <p className="order-2 mt-4 text-sm leading-6" style={{color: '#1D9BF0'}}>Twitter</p>
                  <div className="order-1 text-5xl font-extrabold text-indigo-600">
                ...
                <a href="#" target="_blank" rel="noopener noreferrer" className="cursor-not-allowed flex flex-col hover:bg-indigo-50 rounded-b-lg sm:rounded-r-lg sm:rounded-l-none border-t border-indigo-300 p-6 text-center sm:border-0 sm:border-l">
                  <p className="order-2 mt-4 text-sm leading-6 text-black">Discourse</p>
                  <div className="order-1 text-5xl font-extrabold text-indigo-600">
